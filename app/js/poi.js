...
AFRAME.registerComponent('x', {
    tick: function () {
        ...
        // stepsSource.setPosition(this.el.object3D.getWorldPosition().x, this.el.object3D.getWorldPosition().y, this.el.object3D.getWorldPosition().z); 
